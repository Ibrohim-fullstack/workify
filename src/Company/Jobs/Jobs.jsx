                                    ...
                                    <div className="p-5 md:p-6 pt-0">
                                        <div className="flex flex-col md:flex-row justify-between items-stretch md:items-end gap-6">
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
                                                ...
                                                <Link to={`/jobs/${job.id}`} className="px-6 md:px-[30px] py-3 border-2 border-[#1D3D54] text-[#1D3D54] text-[16px] md:text-[20px] font-[650] rounded-lg text-center whitespace-nowrap">
                                                    View job post
                                                </Link>
                                            </div>
                                        </div>
