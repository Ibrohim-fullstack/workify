        ...
        <footer className="w-full min-h-[497px] flex items-center justify-center bg-[#163D5C] py-8">
            <div className="w-full px-4 sm:px-6 lg:px-8 max-w-[1200px] mx-auto">
                ...
                <div className="w-full h-auto md:h-[252px] flex flex-col md:flex-row justify-between gap-8 md:gap-6 mb-8 md:mb-0">
                    {/* BRAND */}
                    {/* Desktopda md:justify-start va md:gap-4 orqali matnga yaqinlashtirildi */}
                    <div className="w-full md:w-[250px] h-auto flex flex-col justify-between md:justify-start md:gap-4 gap-4">
                        {/* Mobil versiyada items-center orqali bir xil chiziqqa keltirildi */}
                    ...
                    {/* GENERAL */}
                    <div className="flex flex-col border-b border-white/10 md:border-none">
                        <div
                        ...
                        >
                            ...
                            <IoIosArrowDown className={`text-white transition-transform md:hidden ${openSection === 'general' ? 'rotate-180' : ''}`} />
                        </div>
                        <div className={`flex flex-col gap-2 md:gap-[10px] pb-4 md:pb-0 md:flex ${openSection === 'general' ? 'flex' : 'hidden'}`}>
                    ...
                    <div className="flex flex-col border-b border-white/10 md:border-none">
                        ...
                        >
                            ...
                            <IoIosArrowDown className={`text-white transition-transform md:hidden ${openSection === 'company' ? 'rotate-180' : ''}`} />
                        </div>
                        <div className={`flex flex-col gap-2 md:gap-[10px] pb-4 md:pb-0 md:flex ${openSection === 'company' ? 'flex' : 'hidden'}`}>
                    ...
                    <div className="flex flex-col border-b border-white/10 md:border-none">
                        ...
                        >
                            ...
                            <IoIosArrowDown className={`text-white transition-transform md:hidden ${openSection === 'talents' ? 'rotate-180' : ''}`} />
                        </div>
                        <div className={`flex flex-col gap-2 md:gap-[10px] pb-4 md:pb-0 md:flex ${openSection === 'talents' ? 'flex' : 'hidden'}`}>
